...
(9, NULL, 'test', '2018-04-20 05:40:36', 7, 3),
(10, NULL, 'test 2', '2018-04-20 05:46:41', 7, 3),
(11, NULL, 'test school', '2018-04-20 13:06:42', 5, 3);
...
CREATE TABLE IF NOT EXISTS `tbl_mov_age` (
  `mov_age` mediumint(9) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `tbl_mov_age` (`mov_age`, `movies_id`, `arating_id`) VALUES
(1, 1, 3),
(2, 2, 3),
(3, 3, 4),
(4, 5, 2),
